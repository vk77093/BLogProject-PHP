      ...
      <li class="nav-item dropdown text-white"  style="margin-right:40px">
           ...
           <ul class="dropdown-menu">
              <a class="dropdown-item"style="margin-right:80px" href="#"><i class="fa fa-fw fa-user"></i>Profile</a>
               ...
               <a class="dropdown-item" style="margin-right:80px" href="/BLOG_PROJECT/include/logout.php"><i class="fa fa-fw fa-power-off"></i>Log Out</a>
            </ul>
          </li>
...
-->
                ...
                <li class="nav-item">
                <a class="nav-link" href="include/Post.php">
                  <span data-feather="home"></span>
              ...
              <li class="nav-item">
                <a class="nav-link" href="include/DashCategories.php">
                  <span data-feather="file"></span>
                  Catgories
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="include/commentsPost.php">
                  <span data-feather="shopping-cart"></span>
                  Comments
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="include/User.php">
...
<!--
              <li class="nav-item">
                <a class="nav-link" href="include/addUser.php">
...
-->
               <li class="nav-item">
                <a class="nav-link" href="include/Profile.php">
                  <span data-feather="users"></span>
                  Profile
                </a>
              </li>
...
<!--          <canvas class="my-4" id="myChart" width="900" height="380"></canvas>-->
    ...
    <?php include("include/dashbordMain.php"); ?>
        </div>
